  ...
  return (
    <div className="flex flex-col w-full max-w-2xl mx-auto  border-4 border-black bg-white shadow-[10px_10px_0px_0px_rgba(0,0,0,1)]">
      ...
      <div className="border-t-4 border-black p-4 bg-white flex gap-3">
        ...
        />
        <button className="border-4 border-black bg-white px-6 font-black uppercase shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all active:bg-black active:text-white">
          Send
        </button>
      </div>
